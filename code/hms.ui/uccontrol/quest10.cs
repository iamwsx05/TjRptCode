...
namespace Hms.Ui
{
    public partial class Quest10 : UserControl, IQuest
    {
        public Quest10()
        {
            InitializeComponent();
        ...
        public List<EntityDicQnDetail> GetQnCtrls()
        {
            ...
            foreach (Control ctr in plBack.Controls)
            {
                if (ctr is DevExpress.XtraEditors.CheckEdit)
                {
                    ...
                    {
                        data.Add(new EntityDicQnDetail() { fieldId = ((DevExpress.XtraEditors.CheckEdit)ctr).Properties.AccessibleName, questName = "quest10" });
                    }
                }
                if (ctr is DevExpress.XtraEditors.LabelControl)
                {
                    data.Add(new EntityDicQnDetail() { fieldId = ctr.Name, questName = "quest10" });
                }
