...
namespace Hms.Ui
{
    public partial class Quest03 : UserControl, IQuest
    {
        public Quest03()
        {
            InitializeComponent();
        ...
        public List<EntityDicQnDetail> GetQnCtrls()
        {
            ...
            foreach (Control ctr in plBack.Controls)
            {
                if (ctr is DevExpress.XtraEditors.CheckEdit)
                {
                    ...
                    {
                        data.Add(new EntityDicQnDetail() { fieldId = ((DevExpress.XtraEditors.CheckEdit)ctr).Properties.AccessibleName, questName = "quest03" });
                    }
                }
                if (ctr is DevExpress.XtraEditors.LabelControl)
                {
                    data.Add(new EntityDicQnDetail() { fieldId = ctr.Name, questName = "quest03" });
                }
            }
            return data;
        }
